...
#define EAName "XPoints Expert Advisor"
...
*/
   //|---------main signal
      ...
      double MHB=iCustom(Symbol(),0,"AK47-XPoints",per,xrate,xsize,xslope,xminupdn,xhour1,xhour2,xindent,0,shift);
      double MHR=iCustom(Symbol(),0,"AK47-XPoints",per,xrate,xsize,xslope,xminupdn,xhour1,xhour2,xindent,1,shift);
      
      string BUY="false";
      string SELL="false";

      if(MHB>0&&MHB!=EMPTY_VALUE)BUY="true";
      if(MHR>0&&MHR!=EMPTY_VALUE)SELL="true";
